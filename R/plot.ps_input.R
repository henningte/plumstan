#' Plots objects of class \code{ps_input}
#'
#' \code{plot.ps_input} plots a measured depth profile of
...
#' model.
#'
#' @param x An object of class \code{\link{ps_input}}.
