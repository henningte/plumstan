...
#include "stanExports_plumstan_model_cs.h"

RCPP_MODULE(stan_fit4plumstan_model_cs_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_plumstan_model_cs")
