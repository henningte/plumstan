...
private:
        ...
        double lambda;
        std::vector<double> data_cs_age;
        std::vector<double> data_cs_age_sd;
        std::vector<int> data_cs_index;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            pos__ = 0;
            size_t data_chronology_depth_k_0_max__ = (data_chronology_n + data_cs_n);
            for (size_t k_0__ = 0; k_0__ < data_chronology_depth_k_0_max__; ++k_0__) {
                data_chronology_depth[k_0__] = vals_r__[pos__++];
            }
            size_t data_chronology_depth_i_0_max__ = (data_chronology_n + data_cs_n);
            ...
            pos__ = 0;
            size_t index_depth_increments_lower_k_0_max__ = (data_chronology_n + data_cs_n);
            for (size_t k_0__ = 0; k_0__ < index_depth_increments_lower_k_0_max__; ++k_0__) {
                index_depth_increments_lower[k_0__] = vals_i__[pos__++];
            }
            size_t index_depth_increments_lower_i_0_max__ = (data_chronology_n + data_cs_n);
            ...
            pos__ = 0;
            size_t index_depth_increments_upper_k_0_max__ = (data_chronology_n + data_cs_n);
            for (size_t k_0__ = 0; k_0__ < index_depth_increments_upper_k_0_max__; ++k_0__) {
                index_depth_increments_upper[k_0__] = vals_i__[pos__++];
            }
            size_t index_depth_increments_upper_i_0_max__ = (data_chronology_n + data_cs_n);
            ...
            pos__ = 0;
            size_t data_cs_age_k_0_max__ = data_cs_n;
            for (size_t k_0__ = 0; k_0__ < data_cs_age_k_0_max__; ++k_0__) {
                data_cs_age[k_0__] = vals_r__[pos__++];
            }
            size_t data_cs_age_i_0_max__ = data_cs_n;
            for (size_t i_0__ = 0; i_0__ < data_cs_age_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "data_cs_age[i_0__]", data_cs_age[i_0__], 0);
            }
            ...
            pos__ = 0;
            size_t data_cs_age_sd_k_0_max__ = data_cs_n;
            for (size_t k_0__ = 0; k_0__ < data_cs_age_sd_k_0_max__; ++k_0__) {
                data_cs_age_sd[k_0__] = vals_r__[pos__++];
            }
            size_t data_cs_age_sd_i_0_max__ = data_cs_n;
            for (size_t i_0__ = 0; i_0__ < data_cs_age_sd_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "data_cs_age_sd[i_0__]", data_cs_age_sd[i_0__], 0);
            }
            ...
            pos__ = 0;
            size_t data_cs_index_k_0_max__ = data_cs_n;
            for (size_t k_0__ = 0; k_0__ < data_cs_index_k_0_max__; ++k_0__) {
                data_cs_index[k_0__] = vals_i__[pos__++];
            }
            size_t data_cs_index_i_0_max__ = data_cs_n;
            for (size_t i_0__ = 0; i_0__ < data_cs_index_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "data_cs_index[i_0__]", data_cs_index[i_0__], 1);
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> t(((data_chronology_n + 1) + data_cs_n));
            ...
            current_statement_begin__ = 85;
            size_t t_j_1_max__ = ((data_chronology_n + 1) + data_cs_n);
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            current_statement_begin__ = 85;
            validate_non_negative_index("t", "((data_chronology_n + 1) + data_cs_n)", ((data_chronology_n + 1) + data_cs_n));
            Eigen::Matrix<double, Eigen::Dynamic, 1> t(((data_chronology_n + 1) + data_cs_n));
            stan::math::initialize(t, DUMMY_VAR__);
            stan::math::fill(t, DUMMY_VAR__);
